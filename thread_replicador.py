...
def update_firebird(tabela: str, codigo: int, dados,  codigo_global: int = 0):
        try:
            cursor = connection_firebird.cursor()
            ...
            if codigo_global > 0:
                ...
                dados[chave_primaria] = verifica_valor_chave_primaria(tabela, codigo_global, chave_primaria)
