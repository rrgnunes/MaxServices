...
def consultar_ibpt_online(results: pathlib.Path):
    sVersaoRemota = ''
    resultados = []
...
def IBPTNCMCEST():
    ...
    try:
        ...
        pasta_arquivos = os.path.join(parametros.SCRIPT_PATH, 'data')
        if not os.path.exists(pasta_arquivos):
            os.makedirs(pasta_arquivos)

        results = os.path.join(pasta_arquivos, 'resultados.csv')
